...
namespace AppliedProject4thYear.MainPages
{
    ...
    public sealed partial class AttentionPage : Page
    {
        ...
        private void btnBarnDance_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(BarnDance));
        }

        private void btnBearlyWorking_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(BearlyWorking));
        }
